            ...
            vbox:
                ...
                hbox:
                    ...
                    vbox:
                        ...
                        bar value StaticValue(selectedCharacter.Intelligence, 100) xsize 300:
                            left_bar"images/bars/left1.png"
                            right_bar"images/bars/right1.png"
                        text "{b}social skills{/b}"
                        bar value StaticValue(selectedCharacter.Socialskill, 100) xsize 300:
                            left_bar"images/bars/left2.png"
                            right_bar"images/bars/right2.png" 
                        text "{b}Health{/b}"
                        bar value StaticValue(selectedCharacter.Health, 100) xsize 300:
                            left_bar"images/bars/left3.png"
                            right_bar"images/bars/right3.png"
                        text "{b}Porn Addiction{/b}"
                        bar value StaticValue(selectedCharacter.Pornaddiction, 100) xsize 300:
